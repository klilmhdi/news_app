...
class TechnologyNewsPage extends StatelessWidget {
  const TechnologyNewsPage({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => NewsCubit()..getTechnologyNews(),
      child: BlocBuilder<NewsCubit, NewsState>(
        builder: (context, state) {
          NewsCubit cubit = NewsCubit.get(context);
          if (state is TechnoNewsLoading) {
                ...
                child: Container(
                    ...
                    child: ListView.separated(
                      ...
                      itemBuilder: (context, int index) =>
                          buildNewsCard(context, cubit.technology[index]),
                    )),
              ),
            );
          } else {
